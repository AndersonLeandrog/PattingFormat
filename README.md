...
--------> PT-BR
Baixe o arquivo '_App.RAR' neste link: https://www.mediafire.com/file/gy070hhrnpv5en7/_App.rar/file
> O arquivo possui 488.59MB, o download pode demorar, tenha paciência.

Se o seu sistema opera a 32bits, Baixe a pasta '_x32', abra a pasta '_x32' baixada e em seguida abra a pasta 'rar',
arraste ou copie o '_App.RAR' baixado no link acima para dentro de 'rar', pronto, execute o xPattingNFormat.exe.

Caso seu sistema seja de 64bits, repita o procedimento para sistemas 32bits, mas ao invés de baixar a pasta '_x32',
baixe a pasta '_x64'.

OBS: Antes de executar o programa, 
